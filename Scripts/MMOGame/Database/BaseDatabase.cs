...
namespace MultiplayerARPG.MMO
{
    public abstract partial class BaseDatabase : MonoBehaviour
    {
        ...
        public abstract List<SocialCharacterData> FindCharacters(string characterName, int skip = 0, int limit = 50);
        public abstract void CreateFriend(string id1, string id2, int state = 0);
        public abstract void DeleteFriend(string id1, string id2);
        public abstract List<SocialCharacterData> ReadFriends(string id1, int state = 0, int skip = 0, int limit = 50);
